...
# Independent aggressive runner.
# Usage: ./run_sn79_aggressive_independent.sh <COLDKEY_NAME> <HOTKEY_NAME> <AXON_PORT>
#
# PM2 process name is unique per hotkey/port:
#   sn79_aggressive_<HOTKEY_NAME>_<AXON_PORT>
...
AGENT_NAME="MedianAggressiveScoreAgent"
...
PROCESS_NAME="sn79_aggressive_${SAFE_HOTKEY}_${AXON_PORT}"
